...
<head>
    ...
    <script> curl = {apiName: 'require'}; var MOGU = {}; var MoGu = {};</script>
     ...
     <link href="/Public/Home/css/index.css-2435ceae.css" rel="stylesheet" type="text/css"/>



     <link href="/Public/Home/__newtown/detail_mls/assets/mls-pc/pages/normal/index.css-449eac8d.css" rel="stylesheet" type="text/css"/>

    <script type="text/javascript" src="/Public/Home/js/pkg-pc-base.js-beb518b8.js"></script>
...
<div class="shop-header">
    <div class="header clearfix">
        <div class="user-info fl">
            <a href="shop.html#110fni1q" class="avatar" title="爱丽缇旗舰店">

                <img class="face fl" src="/Public/Home/http://d01.res.meilishuo.net/pic/_o/f7/40/968fc99f2f5812ffdffde483183a_200_200.ch.jpg_5f179ba6_s0_100_100.jpg">
            </a>
            <div class="shop-name fl">
                <div class="name-wrap clearfix">
                    <a href="shop.html#110fni1q" class="name fl" title="爱丽缇旗舰店">爱丽缇旗舰店</a>
                    <p class="mark">
                        <img src="/Public/Home/http://s2.mogucdn.com/p1/160512/upload_ie4dcyjwha3tgyjxhazdambqgiyde_60x30.png">
                    </p>
                </div>
                <!-- 评分信息 -->
            ...
            <div id="nav_search_form" class="top_nav_search">
                <form target="_blank" action="http://www.meilishuo.com/search" method="get" id="top_nav_form">
                    <div class="text-wrap clearfix">
                        <input type="text" id="J_SearchKey" class="text ts_txt" autocomplete="off" name="searchKey" placeholder="输入你想要的商品..." data-tel="search_book" data-def="" def-v=""><a href="javascript:;" data-baseurl="shop.html#110fni1q" id="J_SearchInShop" class="search-inshop">搜本店</a><input type="submit" class="submit-btn" value="搜全站">
                    </div>
    ...
    <div class="mod_list clearfix">
        <div class="mod_item w1200" data-id="4634908" data-width="1200" data-type="topBanner" data-title="$commonTopBanner.layoutname">
            <div class="mod_cont topbanner">
                <a class="shop_bg_img" href="shop.html#110fni1q" data-src="/Public/Home/http://imgtest-dl.meiliworks.com/pic/_o/28/ce/2f023f9e3022e39950807e7e2170_2000_120.c5.jpg" style="background: url(http://imgtest-dl.meiliworks.com/pic/_o/28/ce/2f023f9e3022e39950807e7e2170_2000_120.c5.jpg) center no-repeat"></a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="mod_item w1200" data-id="4634909" data-width="1200" data-type="topNav" data-title="$commonTopNav.layoutName">
            <div class="mod_cont topNav">
                <ol class="clearfix">
                    ...
                    <li><a href="shop.html#110fni1q/list/index?categoryId=10702384">热卖单品</a></li>
                    <li><a href="shop.html#110fni1q/list/index?categoryId=10724128">连衣裙</a></li>
                    <li><a href="shop.html#110fni1q/list/index?categoryId=10849050">雪纺/蕾丝衫</a></li>
                    <li><a href="shop.html#110fni1q/list/index?categoryId=10849048">时尚套装</a></li>
                    <li><a href="shop.html#110fni1q/list/index?categoryId=10845418">T恤针织衫</a></li>
                    <li><a href="shop.html#110fni1q/list/index?categoryId=10725286">特惠专区</a></li>
                    <li><a href="shop.html#110fni1q/list/index?categoryId=10725290">夏装上新</a></li>
                    <li><a href="shop.html#110fni1q/list/index?categoryId=20028214">半身裙/短裤</a></li>
                    <li><a href="shop.html#110fni1q/list/index?categoryId=20029296">阔腿裤</a></li>
                </ol>
...
<?php if($goods['is_promote'] != 1): ?><dl class="clearfix event-box">
                                ...
                                <div class="clearfix main-box">
                                    <dl class="clearfix property-box">
                                        ...
                                        <dd class="property-cont property-cont-origin">
                                            <span id="J_OriginPrice" class="price">¥<?php echo ($goods["market_price"]); ?></span>
                                        </dd>
                                    </dl>
                                    ...
                                    <dl class="clearfix property-box">
                                        ...
                                        <dd class="property-cont property-cont-now fl">
                                            <span id="J_NowPrice" class="price" style="color: #333333">¥<?php echo ($goods['shop_price']); ?></span>
											<?php if($goods['is_promote'] == 0): ?><em class="pre-price-desc">（特卖价 ¥<?php echo ($goods['promote_price']); ?>）</em><?php endif; ?>
                                        </dd>
    ...
    <span>累计销量：
      <span class="num J_SaleNum">
         193       </span>
							...
							<form id="goods" onsubmit="return false">
                            <div class="goods-prowrap goods-sku" id="J_GoodsSku">
                                <div class="content">
                                        ...
                                        <dl class="clearfix">
                                            ...
                                            <dd class="num clearfix">
                                                <div id="J_GoodsNum" class="goods-num fl">
                                                    ...
                                                    <input class="num-input"  name="number" type="text" value="1" >
                                                    <button class="num-add" onclick="jia()"></button>
                                                </div>
									...
									<div>
									<?php if(is_array($res2)): foreach($res2 as $key=>$v1): echo ($v1["attr_name"]); ?>
										<dl>
										<?php if(is_array($res1)): foreach($res1 as $key=>$v): if($v['attr_id'] == $v1['attr_id']): ?><input class="xuan" type="radio" name="attr_list[<?php echo ($v['attr_id']); ?>]" value="<?php echo ($v["attr_value"]); ?>" change="jia()" ><?php echo ($v["attr_value"]); ?> &nbsp;&nbsp;&nbsp;<?php endif; endforeach; endif; ?>
                                ...
                                <div class="goods-buy clearfix">
                                    ...
                                    <a href="javascript:;"  onclick="gouwuche()" class="fl mr10 buy-cart buy-btn">加入购物车</a>
                            ...
                            <div class="goods-extra clearfix">
                                ...
                                <div class="extra-services">
                                    ...
                                    <ul class="fl clearfix list">
                                        <li class="item">
                                                                                                                                <span class="link">
                    <img src="/Public/Home/http://s2.mogucdn.com/p1/150923/upload_ieztcoldmvsdmztdgmzdambqgyyde_24x24.png" width="24" height="24">
                    退货补运费
                </span>
                                        </li>
                                        <li class="item">
                                                                                                                                <span class="link">
                    <img src="/Public/Home/http://s2.mogucdn.com/p1/150923/upload_ieywiobrmfsdmztdgmzdambqmeyde_24x24.png" width="24" height="24">
                    7天无理由退货
                </span>
                                        </li>
                                        <li class="item">
                                                                                                                                <span class="link">
                    <img src="/Public/Home/http://s2.mogucdn.com/p1/160618/upload_ie4dqzjrmqzdoojthezdambqgiyde_24x27.png" width="24" height="24">
                    先行赔付
                </span>
                                        </li>
                                        <li class="item">
                                                                                                                                <span class="link">
                    <img src="/Public/Home/http://s2.mogucdn.com/p1/150923/upload_iezgeolcmnsdmztdgmzdambqmmyde_24x24.png" width="24" height="24">
                    72小时发货
                </span>
                                        </li>
                                    </ul>
                    ...
                    <div class="fl goods-topimg" id="J_GoodsImg">
                        ...
                        <div class="big-img">
                            ...
                            <button class="middle">
                                <img id="J_BigImg" src="/Public/Uploads/<?php echo ($goods['goods_img']); ?>" data-main="http://d01.res.meilishuo.net/pic/_o/56/20/136f8f7eff1a84578d1ef245015e_640_832.c1.jpg_f1d98337_s0_468_468.jpg" alt="雪纺裙,收腰,淑女,夏季新品,系带" width="400">
                            </button>
                        </div>
                        ...
                        <div id="J_SmallImgs" class="small-img">
                            <div class="box">
                                <div class="list">
                                    <ul class="clearfix">
									<?php if(is_array($res3)): foreach($res3 as $key=>$v2): ?><img src="/Public/Uploads/<?php echo ($v2["thumb_img"]); ?>"><?php endforeach; endif; ?>
									</ul>
                                </div>
                            </div>
                        ...
                        <ul class="tabbar-list clearfix">
                            ...
                            <li class="qrcode">
                                ...
                                <div class="qrcode-pic">
                                    <!-- <img src="/Public/Home/http://shop.mogujie.com/qrcode/16qub6k"> -->
                                </div>
                        ...
                        <div class="ui-bd">
                            ...
                            <div class="shop-provide">
                                ...
                                <a class="pic" href="javascript:;">
                                    <img class="img-lazyload" width="150" height="26" src="/Public/Home/http://s11.mogucdn.com/p1/150914/upload_ie2dsmbsmyydcmtbgmzdambqgiyde_150x26.png">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="info_text">
                ...
                <p>
                    <a target="_blank" href="http://d03.res.meilishuo.net/pic/_o/e1/80/4f22feee45bb9d0a92e7a950f9c5_1131_1600.cg.jpg" style="display:inline-block;text-decoration:none;height:20px;line-height:20px;">
                        <img src="/Public/Home/http://s18.mogucdn.com/p1/160428/upload_ifrgemjwgq3gemzthazdambqmeyde_20x20.png" style="float:left;">
...
<!-- <script type="text/javascript" src="/Public/Home/js/index.js-8f5416c3.js"></script> -->

<script type="text/javascript" src="/Public/Home/__newtown/detail_mls/assets/mls-pc/pages/normal/index.js-957ad653.js"></script>
<script type="text/javascript" src="/Public/Admin/js/jquery.min.js"></script>
<script>
	function gouwuche(){
		var goods = $("#goods").serialize();
		$.post("<?php echo U('Goods/che');?>",goods,function(res){
			alert(res);
		});
	}
	function jia(){
