        ...
        <div class="x-body">
                ...
                <div class="layui-form-pane" style="margin-top: 15px;">
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:80px">
                        <a class="layui-btn"  href="<?php echo U('Brand/add');?>" ><i class="layui-icon">&#xe608;</i>增加</a>
                    </div>
                  </div>
                </div> 
            </form>
            ...
            <table class="layui-table">
				...
				<?php if(is_array($res)): foreach($res as $key=>$v): ?><tr>
                        <td>
                            <input type="checkbox" value="<?php echo ($v["brand_id"]); ?>" name="brand_id">
                        </td>
                        <td>
                            <?php echo ($v["brand_id"]); ?>
                        </td>
						...
						<td>
                            <?php echo ($v["brand_desc"]); ?>
                        </td>
						<td>
							<img src="/Public/Uploads/<?php echo ($v['brand_logo']); ?>"></img>
                        </td>
						<td>
                            <?php echo ($v["site_url"]); ?>
                        </td>
