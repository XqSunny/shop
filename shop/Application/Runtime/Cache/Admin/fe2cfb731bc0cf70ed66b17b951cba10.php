        ...
        <div class="x-body">
                ...
                <div class="layui-form-pane" style="margin-top: 15px;">
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:80px">
                        <a class="layui-btn"  href="<?php echo U('Category/add');?>" ><i class="layui-icon">&#xe608;</i>增加</a>
                    </div>
                  </div>
                </div> 
            </form>
            ...
            <table class="layui-table">
				...
				<?php if(is_array($res)): foreach($res as $key=>$v): ?><tr>
                        <td>
                            <input type="checkbox" value="<?php echo ($v["cat_id"]); ?>" name="cat_id">
                        </td>
                        <td>
                            <?php echo ($v["cat_id"]); ?>
                        </td>
						...
						<td>
						<?php if(array_key_exists($v['parent_id'],$arr)): echo ($arr[$v['parent_id']]); ?>
						<?php else: ?>
							顶级分类<?php endif; ?>
                        </td>
						<td>
                            <?php if($v['is_nav'] == 0): ?>否<?php else: ?>是<?php endif; ?>
                        </td>
						<td>
                            <?php if($v['is_show'] == 0): ?>否<?php else: ?>是<?php endif; ?>
                        </td>
                        <td class="td-manage">
