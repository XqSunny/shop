        ...
        <div class="x-body">
                ...
                <div class="layui-form-pane" style="margin-top: 15px;">
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:80px">
                        <a  href="<?php echo U('Goods/addgallery','goods_id='.$goods_id);?>" class="layui-btn"><i class="layui-icon">&#xe608;</i>增加</a>
                    </div>
                  </div>
                </div> 
            </form>
            ...
            <table class="layui-table">
				...
				<?php if(is_array($res)): foreach($res as $key=>$v): ?><tr>
                        <td>
                            <input type="checkbox" value="<?php echo ($v["gallery_id"]); ?>" name="gallery_id">
                        </td>
						<td>
						<?php echo ($v["gallery_id"]); ?>
						</td>
                        <td>
                            <?php echo ($v["goods_id"]); ?>
                        </td>
						...
						<td>
                            <img src="/Public/Uploads/<?php echo ($v["thumb_img"]); ?>"/>
                        </td>
						<td>
                           <img style="width:200px;height:200px;" src="/Public/Uploads/<?php echo ($v["original_img"]); ?>"/>
                        </td>
