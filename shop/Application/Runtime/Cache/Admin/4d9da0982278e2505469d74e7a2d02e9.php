...
<html>
    ...
    <body>
        ...
        <div class="x-body">
            <form class="layui-form x-center" action="<?php echo U('Type/doadd');?>" method="post" style="width:50%">
                <div class="layui-form-pane" style="margin-top: 15px;">
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:80px">
                        <button type="submit"  class="layui-btn"><i class="layui-icon">&#xe608;</i>增加</button>
                    </div>
                  </div>
                </div> 
            </form>
            ...
            <table class="layui-table">
				...
				<?php if(is_array($res)): foreach($res as $key=>$v): ?><tr>
                        <td>
                            <input type="checkbox" value="<?php echo ($v["goods_type_id"]); ?>" name="goods_type_id">
                        </td>
                        <td>
                            <?php echo ($v["goods_type_id"]); ?>
                        </td>
                        <td>
